...
public interface EncryptionService {
     ...
     * @throws IllegalStateException si clave no disponible
     * @throws RuntimeException si desencriptacion falla (wrong key o corrupted)
     */
    String decryptFromBase64(String ciphertextBase64);

    /**
     * Encripta bytes (para archivos binarios como evidencias).
     *
     * @param plainBytes Bytes en texto plano
     * @return Bytes cifrados (IV + ciphertext + tag)
     * @throws IllegalStateException si clave no disponible
     * @throws RuntimeException si encriptacion falla
     */
    byte[] encryptBytes(byte[] plainBytes);

    /**
     * Desencripta bytes (para archivos binarios como evidencias).
     *
     * @param encryptedBytes Bytes cifrados (IV + ciphertext + tag)
     * @return Bytes en texto plano
     * @throws IllegalStateException si clave no disponible
     * @throws RuntimeException si desencriptacion falla
     */
